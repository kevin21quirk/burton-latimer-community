...
async function main() {
  ...
  console.log(`Deleting existing posts and recreating with images...`);
...
We're absolutely delighted to welcome you to **Latimer Community** - a safe, supportive platform designed to bring together individuals, local businesses, and charities across Burton Latimer.
...
Genuine helpers will **never** pressure you, ask for money upfront, or request sensitive personal information.

**Your safety is our priority.** If you're unsure about anything, please reach out to us. 💙`,
      userId: adminUser.id,
...
**Let's work together to keep our community safe and supportive!** 💙`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?w=1200'],
      createdAt: daysAgo(5),
    }
  });
...
**Together, we can build a community where everyone feels safe and supported.** 💛`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=1200'],
      createdAt: daysAgo(4),
    }
  });
...
If you're interested, please send me a message. Thank you for reading. 💐`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=1200'],
      createdAt: daysAgo(3),
    }
  });
...
Thank you for considering! 🙏`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1604719312566-8912e9227c6a?w=1200'],
      createdAt: daysAgo(3),
    }
  });
...
Any information would be greatly appreciated. Thank you.`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=1200'],
      createdAt: daysAgo(2),
    }
  });
...
Thank you for understanding. 🙏`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1554224311-beee460c201f?w=1200'],
      createdAt: daysAgo(2),
    }
  });
...
If you enjoy gardening and have some spare time, I'd be so grateful! 🌻`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=1200'],
      createdAt: daysAgo(1),
    }
  });
...
If you need help getting to medical appointments, please message me. **No charge** - just happy to help our community! 🙏`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=1200'],
      createdAt: daysAgo(1),
    }
  });
...
If you or someone you know could benefit, please get in touch! 🏠`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=1200'],
      createdAt: daysAgo(1),
    }
  });
...
**Technology shouldn't be a barrier to staying connected.** If you need help, please reach out! 📱`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=1200'],
      createdAt: daysAgo(1),
    }
  });
...
For more information, visit your local library or contact Citizens Advice. 💙`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1593113598332-cd288d649433?w=1200'],
      createdAt: daysAgo(0),
    }
  });
...
If you're struggling, please reach out to these trusted organisations. 🙏`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?w=1200'],
      createdAt: daysAgo(0),
    }
  });
...
**Your safety comes first.** Never feel pressured to accept help if you're uncomfortable. 🛡️`,
      userId: adminUser.id,
      images: ['https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1200'],
      createdAt: daysAgo(0),
    }
  });
...
**Stay safe and trust your instincts!** 💙`,
  ...
  console.log('✅ Successfully created all sample posts with images!');
  console.log('\nPost Summary:');
  ...
  console.log('\nTotal: 17 posts created with engaging images and formatting');
}
